...
const FEATURES = [
  ...
  { icon: Clapperboard,     title: 'Higgsfield Video AI',       desc: 'Generate cinematic clips from text or images with Higgsfield AI.' },
];
...
const QUICK_ACTIONS = [
  ...
  { href: '/higgsfield',   icon: Sparkles,  label: 'Higgsfield AI Studio', color: 'from-fuchsia-600 to-purple-600' },
];
